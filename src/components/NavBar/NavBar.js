...
const NavBar = () => {
    ...
    return (
        <div className='sticky top-0'>
            <nav className='flex items-center justify-between p-5 bg-violet-700 w-full'>
                ...
                <div>
                    <ul className={`bg-violet-700 w-full duration-1000 ease-linear top-14  ${open ? 'right-0' : 'right-[-800px]'} fixed md:static`} >
